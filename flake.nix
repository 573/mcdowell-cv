{
  description = "A flake to build labels_Template.tex";
        ...
        default =
	      ...
	      in pkgs.stdenvNoCC.mkDerivation rec {
			...
			buildInputs = [
			  ...
			  (pkgs.texlive.combine {
			    inherit (pkgs.texlive)
			      scheme-small latexmk tabu labels changepage enumitem catchfile latex-bin fontspec textpos isodate substr eso-pic microtype;
			...
			buildPhase = ''
			  ...
			  latexmk -pdflua -verbose -f -rules -lualatex ./labels_Template.tex
			'';

			installPhase = ''
			  mkdir -p $out
			  cp labels_Template.pdf $out/
			'';
